...
import {INSERT_MATCH} from "../../gql/match";
...
const CreateMatchView = () => {
    ...
    // Start Mutation
    const [insertMatch] = useMutation(INSERT_MATCH, {
        onError: (error) => {
        ...
        <LayoutView>
            ...
            <div className="grid grid-cols-4 gap-7 mx-10 mb-5">
                ...
                <div className="col-span-2 justify-self-end">
                    <button className="bg-red-500 text-white rounded shadow hover:bg-red-400 mr-3 px-4 py-3" onClick={cancelMatch}>Cancel</button>
