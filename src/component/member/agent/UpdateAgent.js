const UpdateAgent = ({updateModalHandle}) => {
    return (
            ...
            <div className="w-11/12 bg-white rounded shadow shadow-gray-400 mx-auto py-5 px-3">
                ...
                <div className="grid grid-cols-3 gap-6">
                    ...
                    <div className="col-span-3 text-right sm:col-span-2">
                        ...
                        <button className="bg-blue-500 text-white rounded shadow hover:bg-blue-400 px-4 py-3" onClick={() => console.log("Update Agent")}>Update</button>
                    </div>
                </div>
                {/*End Update Form */}
            </div>
