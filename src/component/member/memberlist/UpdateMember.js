const UpdateMember = ({updateModalHandle}) => {
    return (
        <div className="w-full h-full bg-gray-50 flex justify-center items-center bg-opacity-80 absolute top-0">
            <div className="w-11/12 bg-white rounded shadow shadow-gray-400 mx-auto py-5 px-3">
                <div>
                    <p className="text-3xl font-bold leading-4">Update Member</p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-6">
                    ...
                    <div className="col-span-3 text-right sm:col-span-2">
                        ...
                        <button className="bg-blue-500 text-white rounded shadow hover:bg-blue-400 px-4 py-3" onClick={() => console.log("Update Member")}>Update</button>
                    </div>
                </div>
                {/*End Update Form */}
            </div>
