                ...
                betSlip.length > 0 ?
                    betSlip.map(slip => (
                        <tr className="hover:bg-gray-50" key={slip.id}>
                            ...
                            <td className="px-4 py-4">{ slip.bet_slip.win_lose_cash.toFixed(2) * (slip.percent_commision).toFixed(3)/100}</td>
                            <td className="px-4 py-4">
                                {
                                    Math.sign(slip.bet_slip.win_lose_cash) === -1 ?
                                        <span className="text-red-500">{(slip.bet_slip.win_lose_cash * (slip.percent_commision).toFixed(3)/100).toFixed(2)}</span>
                                    :
                    ...
                    <td className="px-4 py-4">
                        {
                            ...
                            :
                                (total.totalNewGroupWinLose * (0.95 + total.totalNewGroupComission.toFixed(3) / 100)).toFixed(2)
                        }
                    </td>
                </tr>
            }
