...
const CreateSecondMatch = ({addSecondModalHandle, matchResult}) => {
    // useState
                ...
                <div className="grid grid-cols-4 gap-7 mx-10 mb-5">
                    ...
                    <div className="col-span-2 relative">
                        <div className="flex shadow rounded-md">
                            ...
                            <select className={`block w-full flex-1 rounded-none rounded-r-md border ${error.match ? "border-red-400" : "border-gray-400"} focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm pl-3 py-3`} value={form.match} onChange={(e) => inputHandle(e, "match")} disabled={form.match}>
